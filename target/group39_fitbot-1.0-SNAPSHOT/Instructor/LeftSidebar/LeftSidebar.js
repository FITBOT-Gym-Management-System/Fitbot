...
// workout
 $('#ins_workout').click(function(){
  ...
  if(load[5] == 0){
    $(sideBar_links_variable).load('http://localhost:8080/group39_fitbot_war_exploded/Instructor/INSTRUCTOR_WORKOUT_PLAN/workout_plan_create.html #workout_plan_create_main_page',function(responseTxt, statusTxt, xhr){
...
$('#ins_diet').click(function(){
  ...
  if(load[6] == 0){
    $(sideBar_links_variable).load('http://localhost:8080/group39_fitbot_war_exploded/Instructor/INSTRUCTOR_DIET_PLAN/instructor_diet_plan.html #home_content_diet_fit',function(responseTxt, statusTxt, xhr){
