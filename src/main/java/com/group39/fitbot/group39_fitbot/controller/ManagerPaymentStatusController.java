...
import com.group39.fitbot.group39_fitbot.dao.ManagerPaymentStatusDAO;
...
public class ManagerPaymentStatusController extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        boolean Payment_statusChange=false;

        try {
            Payment_statusChange = ManagerPaymentStatusDAO.setCashPaymentStatus(payment_id);
